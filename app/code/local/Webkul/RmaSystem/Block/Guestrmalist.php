<?php
	...
	class Webkul_RmaSystem_Block_Guestrmalist extends Mage_Core_Block_Template	{

		public function __construct()    {
            parent::__construct();
            $session_data = Mage::getSingleton("core/session")->getGuestData();
            $collection = Mage::getResourceModel("rmasystem/rma_collection")->addFieldToFilter("guest_email",$session_data["email"])->setOrder("id","DESC");;

            $filter_data = Mage::getSingleton("core/session")->getGuestRmaFilterData();
            ...
            $sorting_data = Mage::getSingleton("core/session")->getRmaSortingData();
