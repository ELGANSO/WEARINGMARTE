...
$j(document).ready(function () {
    ...
    jQuery('#nav').find('.parent').append('<strong></strong>');
    jQuery('#nav li.parent').each(function() {
        if (jQuery(this).hasClass('active')){
            jQuery(this).find('> .level-top').slideDown(0);
            jQuery(this).find('> strong').addClass('opened');
        }
    })
    jQuery('#nav li.parent strong').on("click", function(){
        if (jQuery(this).attr('class') == 'opened') { jQuery(this).removeClass().parent('.parent').find('> .level-top').slideUp(200); }
        else {
            jQuery(this).addClass('opened').parent('.parent').find('> .level-top').slideDown(200);
        }
    });
