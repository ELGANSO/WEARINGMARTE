<?php
	...
	class Webkul_RmaSystem_Helper_Data extends Mage_Core_Helper_Abstract {
        ...
        public function orderQualifiesForRma($orderId)
        {
            ...
            {
                if($this->orderItemQuailifiesForRma($item->getId()))
                {
                    return true;
                }
            }
         ...
         * @return bool
         */
        public function orderItemQuailifiesForRma($orderItemId)
        {
            // Comprobamos si el item ya se encuentra implicado en alguna otra devolución
            // que no esté cancelada o denegada
