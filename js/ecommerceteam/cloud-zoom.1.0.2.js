    ...
    function CloudZoom(jWin, opts) {
        ...
        this.controlLoop = function () {
            if (lens) {
                ...
                destU = (((x) / sImg.outerWidth()) * zoomImage.width*1.1) >> 0;
                destV = (((y) / sImg.outerHeight()) * zoomImage.height*1.1) >> 0;
...
/* Add a box (mouseTrap) over the small image to trap mouse events.
        ...
        */
            ...
            $mouseTrap.bind('mouseenter', this, function (event) {
                ...
                zoomDiv = appendTo.append(format('<div id="cloud-zoom-big" class="cloud-zoom-big" style="display:none;position:absolute;left:%0px;top:%1px;width:%2px;height:%3px;background-image:url(\'%4\');z-index:99;background-size:280%;background-repeat:no-repeat;"></div>', xPos, yPos, w, h, zoomImage.src)).find(':last');
